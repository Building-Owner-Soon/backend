...
class AuthController(
    ...
    suspend fun signUp(signUpRequestDTO: SignUpRequestDTO): CommonSignResponseDTO = authService.signUp(signUpRequestDTO)

    @PostMapping("/auth/sign-in")
    @ResponseStatus(HttpStatus.OK)
    suspend fun signIn(signInRequestDTO: SignInRequestDTO): CommonSignResponseDTO = authService.signIn(signInRequestDTO)
//
//    @GetMapping("/me")
//    @ResponseStatus(HttpStatus.OK)
